...
export default function OrderPage() {
  ...
  const { cartItems, addToCart, updateQuantity, removeFromCart, total } = useCart()
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredItems.map(item => {
                ...
                return (
                  <div key={item.id} className="bg-[#1A1400] rounded-2xl overflow-hidden border border-[#2E2200] hover:border-gold hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.7)] transition-all duration-300 group">
            ...
            <div className="bg-[#100C02] border border-[#2E2200] rounded-2xl p-6">
              ...
              {cartItems.length === 0 ? (
                ...
                <>
                  ...
                  <button className="w-full bg-gold text-bg-page py-4 rounded-lg text-[13px] uppercase tracking-[2px] font-bold hover:bg-gold-bright transition mb-3" style={{fontFamily: 'Inter, sans-serif'}}>
                    Proceed to Checkout
                  </button>
